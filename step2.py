...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 17 18:13:37 2020
...
class MIRCO:
    ...
    def greedySCP(self, c, A):
        ...
        # LAR is used as specified in the report to make the greedy algorithm faster
        ...
        R = M
        S = set()
        uncovered = np.sum(A[list(R),:], axis=0)
        
        while (np.count_nonzero(uncovered) > 0):

            cost = np.divide(c,uncovered)
